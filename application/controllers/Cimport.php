        ...
        if (isset($_FILES['upload_file']) && $_FILES['upload_file']['error'] == 0) {
            ...
            if ($sheetcount > 1) {
                ...
                for ($i = 1; $i < $sheetcount; $i++) {
                    ...
                    // Debugging: Output data yang diproses
                    echo "Row $i: Nama: $nama, NIM: $nim, Email: $email, Tanggal Lahir: $tgl_lahir_excel<br>";
                    ...
                    // Debugging: Output format tanggal setelah konversi
                    echo "Row $i: Tanggal Lahir Formatted: $tgl_lahir_formatted<br>";
